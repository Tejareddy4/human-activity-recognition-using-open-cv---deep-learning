...
#for input video python HAR.py --model resnet-34_kinetics.onnx --classes Actions.txt --input videos/example_activities.mp4 --gpu 1 --output output.mp4
#For Live can use this command : python HAR.py --model resnet-34_kinetics.onnx --classes Actions.txt


# we will pass argument using argument parser so construct argument parser.
...
argv.add_argument("-d", "--display", type=int, default=1,
                  help="to display output frame or not")
...
while True:
    ...
    for frame in originals:
        ...
        # for output video being already given
